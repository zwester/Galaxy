...
namespace WindowsGame1
{
    public class Card
    {
        ...
        public static void buildSQLDeck(string datasource, string tblName)
        {
            ...
            string sql = ",'old earth',3,2,1,1,0,'','','','','draw:1','1 of any good for 1vp,up to 2 times','')>" +//0
                        ",'epsilon eridani',2,1,1,1,0,'','','','military:1','','1 of any good for 1vp and 1card','')>" +//1
                        ",'alpha centauri',2,0,1,1,0,'brown','','','specific:C:brown:1,specific:M:brown:1','','','')>" +
                        ",'new sparta',2,1,1,1,1,'','','','military:2','','','')>" +
                        ",'earth''s lost colony',2,1,1,1,0,'','','','','','1 of any good for 1vp','1blue')>" +
                        ",'rebel fuel cache',1,1,1,0,1,'brown','','','','','','')>" +//5
                        ",'public works',1,1,0,0,0,'','','after:1','','','1 of any good for 1vp','')>" +
                        ...
                        ",'pilgrimage world',0,2,1,0,0,'','','','','','discard all to gain that many VPs-1','')>" +
                        ...
                        ",'expanding colony',1,1,1,0,0,'','','','','','any good for one VP','produce on a blue windfall')>" +
                        ",'expedition force',1,1,0,0,0,'','draw:1','','military:1','','','')>" +
                        ",'export duties',1,1,0,0,0,'','','','','draw:1','','')>" +
                        ",'gambling world',1,1,1,0,0,'','','','','','any good for one VP,guess cost or defense of card and keep it if you''re right','')>" +//30
                        ",'investment credits',1,1,0,0,0,'','','reduce:1','','','','')>" +
                        ",'investment credits',1,1,0,0,0,'','','reduce:1','','','','')>" +
                        ",'new military tactics',1,1,0,0,0,'','','','temp:3','','','')>" +
                        ",'new survivalists',1,1,1,0,0,'','','','','','1blue for 1card','1blue')>" +
                        ",'outlaw world',1,1,1,0,1,'','','','','','any good for 1 VP and 1 card','')>" +//35
                        ",'public works',1,1,0,0,0,'','','after:1','','','any good for 1VP','')>" +
                        ",'runaway robots',1,1,1,0,1,'brown','','','','','','draw 1 card if produced on this world')>" +
                        ",'secluded world',1,1,1,0,0,'','','','','','1 of any good for 1 card','1blue')>" +
                        ...
                        ",'colony ship',2,1,0,0,0,'','','','freeWorld','','','')>" +
                        ",'deficit spending',2,1,0,0,0,'','','','','','','1 card for 1VP up to 2 times,cant be doubled')>" +//45
                        ",'deficit spending',2,1,0,0,0,'','','','','','','1 card for 1VP up to 2 times,cant be doubled')>" +
                        ...
                        ",'mining robots',2,1,0,0,0,'','','','specific:C:brown:1','','','produce on a brown windfall')>" +
                        ",'new vinland',2,1,1,0,0,'','','','','','trade any good for 2cards','1blue')>" +
                        ...
                        ",'black market trading world',3,2,1,0,0,'','','','','','trade 1 of any good but don''t apply trade powers','')>" +
                        ",'blaster gem mines',3,2,1,0,0,'brown','','','military:1','','','')>" +
                        ",'galactic resort',3,2,1,0,0,'','','','','','1 of any good for 1 VP and 1card','')>" +
                        ",'mining conglomerate',3,2,0,0,0,'','','','','specific:brown:1','1 brown for 1VP up to 2 times','draw 2 cards if produced the most brown')>" +
                        ",'mining conglomerate',3,2,0,0,0,'','','','','specific:brown:1','1 brown for 1VP up to 2 times','draw 2 cards if produced the most brown')>" + //65
                        ",'mining world',3,2,1,0,0,'','','','','','','1brown and draw 1card')>" +
                        ",'pirate world',3,2,1,0,1,'blue','','','','this:3','','')>" +
                        ",'plague world',3,0,1,0,0,'','','','','','1green for 1VP and 1card','1green')>" +
                        ",'prosperous world',3,2,1,0,0,'','','','','','1 of any for 1VP','1blue')>" +
                        ",'rebel underground',3,4,1,0,1,'','','','','','','1card')>" + //70
                        ",'rebel warrior race',3,2,1,0,1,'green','','','military:1','','','')>" +
                        ",'terraforming robots',3,2,0,0,0,'','','','after:1','','1brown for 1VP and 1card','')>" +
                        ",'terraforming robots',3,2,0,0,0,'','','','after:1','','1brown for 1VP and 1card','')>" +
                        ...
                        ",'diversified economy',4,2,0,0,0,'','','','','','discard 3 different kinds of good to get 3VP','draw 1 card for each kind of good')" +
                        ",'diversified economy',4,2,0,0,0,'','','','','','discard 3 different kinds of good to get 3VP','draw 1 card for each kind of good')" +
                        ",'drop ships',4,2,0,0,0,'','','','military:3','','','')" +
                        ",'drop ships',4,2,0,0,0,'','','','military:3','','','')" + //80
                        ",'imperium armaments world',4,2,1,0,0,'','','','military:1','','','1brown')" +
                        ",'merchant world',4,2,1,0,0,'','','','','draw:2','discard up to 2 cards for 1VP each, no doubling','')" +
                        ",'replicant robots',4,2,0,0,0,'','','','reduce:2','','','')" +
                        ",'replicant robots',4,2,0,0,0,'','','','reduce:2','','','')" +
                        ",'research labs',4,2,0,0,0,'keep:1','','','','','1green for 1VP','draw 1card for each yellow produced')" + //85
                        ",'research labs',4,2,0,0,0,'keep:1','','','','','1green for 1VP','draw 1card for each yellow produced')" +
                        ",'tourist world',4,2,0,0,0,'','','','','','2 goods for 3VP','')" +
                        ",'consumer markets',5,3,0,0,0,'','','','','','up to 3 blues for 1VP each','draw 1card for each blue produced')" +
                        ",'consumer markets',5,3,0,0,0,'','','','','','up to 3 blues for 1VP each','draw 1card for each blue produced')" +
                        ",'deserted alien colony',5,4,1,0,0,'yellow','','','','','','')" + //90
                        ",'galactic trendsetters',5,3,1,0,0,'','','','','','1 of any good for 2VP','')" +
                        ",'lost alien warship',5,3,1,0,1,'yellow','','','military:2','','','')" +
                        ",'lost species ark world',5,3,1,0,0,'','','','','',''1green then draw +2cards,'')" +
                        ",'new earth',5,3,1,0,0,'','','','','','1 of any good for 1card and 1VP','1brown')" +
                        ",'rebel outpost',5,5,1,0,1,'','','','military:1','','','')" + //95
                        ",'terraformed world',5,5,1,0,0,'','','','','','1 of any good for 1VP','')";
